...
int locomotionMode = 0;  // 0: Rectilinear, 1: Lateral Undulation, 2: Sidewinding, 3: Concertina
...
void loop() {
    ...
    locomotionMode = static_cast<int8_t>(cmd.bytes[0]);  // change locomotion mode 
    ...
    // choose locomotion mode
    switch (locomotionMode) {
        case 0: // Rectilinear
            rectilinearMovement();
            break;
        case 1: // Lateral Undulation
            lateralUndulation();
            break;
        case 2: // Sidewinding
            sidewindingMovement();
...
void rectilinearMovement() {
motor1.startSinusoidalOscillation(freq1, amp1, phase1); //fixed freq, amp, phase 
motor2.startSinusoidalOscillation(freq2, amp2, phase2); //fixed freq, amp, phase
}

void lateralUndulation() {
motor1.startSinusoidalOscillation(freq1, amp1, phase1); //fixed freq, amp, phase
motor2.startSinusoidalOscillation(freq2, amp2, phase2); //fixed freq, amp, phase
}

void sidewindingMovement() {
motor1.startSinusoidalOscillation(freq1, amp1, phase1); //fixed freq, amp, phase
motor2.startSinusoidalOscillation(freq2, amp2, phase2); //fixed freq, amp, phase
}

void concertinaMovement() {
motor1.startSinusoidalOscillation(freq1, amp1, phase1); //fixed freq, amp, phase
motor2.startSinusoidalOscillation(freq2, amp2, phase2); //fixed freq, amp, phase
}
